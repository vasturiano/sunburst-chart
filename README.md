...
| <b>animationDuration</b>([<i>number</i>]) | Set the animation duration when the chart appears on screen. Enter 0 to disable the animation. The default is `750` (ms). | `750` |
